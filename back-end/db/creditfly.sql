...
CREATE TABLE expenditure (
    ...
    dinning_expeneses INTEGER NOT NULL,
...
INSERT INTO expenditure (travel_expenses,  dinning_expeneses, rent_expenses, gas_expenses, others_expenses, users_id)
...
('American Express Platinum', 5, 'Execellent for travel, dining 5 pts per dollars on airfare and hotels, great perks', 'https://icm.aexp-static.com/Internet/Acquisition/US_en/AppContent/OneSite/CardArt/My-Card/L-Desktop/platinum.png?CPS_CARD_SHOP_VER', 10),
...
('Amex Premier Gold', 4, 'Great Sign up bonus and good for categories', 'https://icm.aexp-static.com/Internet/Acquisition/US_en/AppContent/OneSite/category/cardarts/premier-rewards-gold.png', 7),
